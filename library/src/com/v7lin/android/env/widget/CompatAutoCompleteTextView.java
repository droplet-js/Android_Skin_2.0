...
public class CompatAutoCompleteTextView extends AutoCompleteTextView implements XTextViewCall, EnvCallback {
...
//		this(context, attrs, com.android.internal.R.attr.autoCompleteTextViewStyle);
	...
	public CompatAutoCompleteTextView(Context context, AttributeSet attrs, int defStyle) {
		...
		mEnvUIChanger = new EnvTextViewChanger<TextView, XTextViewCall>(context);
